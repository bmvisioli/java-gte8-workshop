...
public class Streams {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    Stream<String> builderStream = Stream.<String>builder().add("The builder put me here").build();
    ...
    // Or become parallel later... and become sequential again
    Stream.empty().parallel().sequential();
    ...
    println("Stream has been created but not evaluated");
    ...
    try {
      ...
      println(e.getMessage()); // "stream has already been operated upon or closed"
    }
