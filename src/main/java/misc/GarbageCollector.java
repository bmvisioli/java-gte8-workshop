  ...
  public static void main(String[] args) throws IOException {
    ...
    \____/   \__,_/  /_/     /_.___/ \__,_/   \__, /  \___/
      ...
      G1
        ...
        java -XX:+UseG1GC src/main/java/misc/GarbageCollector.java
      ...
      Epsilon
        ...
        java -XX:+UnlockExperimentalVMOptions -XX:+UseEpsilonGC src/main/java/misc/GarbageCollector.java
      ...
      ZGC
        ...
        java -XX:+UnlockExperimentalVMOptions -XX:+UseZGC src/main/java/misc/GarbageCollector.java

      CMS GC:
        java -XX:+UseConcMarkSweepGC src/main/java/misc/GarbageCollector.java
      Parallel GC:
        java -XX:+UseParallelGC src/main/java/misc/GarbageCollector.java
      Serial GC:
        java -XX:+UseSerialGC src/main/java/misc/GarbageCollector.java
